...
# Cases
miller = Case.create(name: "Miller v. Flatiron Financial Services", counsel: "Serje P. Havandjian, Esq.", date_case_filed:"2022-07-15", date_complaint_served:"2022-07-18")
smith = Case.create(name: "Smith v. Flatiron Financial Services", counsel: "Serje P. Havandjian, Esq.", date_case_filed:"2022-07-15", date_complaint_served: "2022-07-18")
johnson = Case.create(name: "Johnson v. Flatiron Financial Services", counsel: "Serje P. Havandjian, Esq.", date_case_filed:"2022-07-15", date_complaint_served: "2022-07-18")
...
# Milestones
milestonesForMillerDemurrer = MilestonesForDemurrer.create(m1: "Analyze Complaint", m2: "Begin Drafting Demurrer", m3: "Provide Draft Demurrer to Partner", m4: "Provide Draft Demurrer to Client", m5: "Meet and Confer With Opposing Counsel", m6: "Draft Client Declaration, Counsel Declaration, Potential Request for Judicial Notice, and Proposed Order", m7: "Finalize Demurrer & Related Documents for File and Service", m8: "File and Serve Demurrer", deadline_id: miller_complaint_demurrer_deadline.id)

milestonesForMillerAnswer = MilestonesForAnswer.create(m1: "Analyze Complaint", m2: "Draft Answer (NOTE: If Complaint Verified, Answer Each Paragraph In Complaint Specifically)", m3: "Provide Draft To Partner", m4: "File and Serve Answer", deadline_id:miller_complaint_answer_deadline.id)
